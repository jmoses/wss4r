module WSS4R
  ...
  def process(document, parent_path = "/env:Envelope/env:Header")
            ...
            security = header.add_element(Names::SECURITY, {})
            signature = security.add_element(Names::SIGNATURE, {}) #"env:mustUnderstand"=>"1"})
            signature.add_namespace("xmlns:ds", Namespaces::DS)
